...
use EconomySystem\Data\AccountData;
use EconomySystem\EconomySystem;
use EconomySystem\Service\EconomyService;
use EconomySystem\Utils\Container;

class EconomyServiceProvider implements ServiceProviderInterface
{
    public function register(Container $c)
    {
        $c->singleton(AccountData::class, function(Container $c) {
            return new AccountData(EconomySystem::getInstance()->getDataFolder() . DIRECTORY_SEPARATOR . 'data' . DIRECTORY_SEPARATOR);
        });
